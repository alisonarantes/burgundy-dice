...
const i18n = {
    en: {
        uiTitle: "The Castles of Burgundy: The Dice Game <span style='font-size: 0.8rem; color: var(--text-muted); font-weight: normal; margin-left: 10px;'>v1.12</span>",
        menu: "☰ Menu",
        historyBtn: "Scores",
        rulesBtn: "Rules",
        newgameBtn: "New Game",
    ...
    pt: {
        uiTitle: "The Castles of Burgundy: O Jogo de Dados <span style='font-size: 0.8rem; color: var(--text-muted); font-weight: normal; margin-left: 10px;'>v1.12</span>",
        menu: "☰ Menu",
